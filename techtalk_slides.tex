% \documentclass[10pt, compress, handout]{beamer}	%% use this for flattened handout version
\documentclass[10pt, compress]{beamer}		%% use this for presentation mode
...
{\usebackgroundtemplate{\includegraphics[height=\paperheight]{images/ns-bg.jpg}} \maketitle}
...
\begin{frame}{Excerpt from a Quill Report}
	\textbf{Top 5 Stocks by Absolute Return Contribution to Fund Performance}\\

	The stock that contributed the most to the
	portfolio was Arcam AB. This security alone
	contributed 0.32 to the portfolio’s overall
	return during the period. Including Arcam AB,
	there were 89 other stocks that had a positive
	contribution, out of 204 securities held.
	\begin{itemize}
		\item Arcam AB: 0.32
		\item Sumitomo Mitsui Financial Group,
		Inc.: 0.32
		\item JP Holdings: 0.31
		\item Hulic Co: 0.29
		\item Wacom Co: 0.27
	\end{itemize}

	{\tiny \href{https://narrativescience.com/Resources/Resource-Library/Article-Detail-Page/Quill-Portfolio-Commentary-Asset-Management}{https://narrativescience.com/Resources/Resource-Library/Article-Detail-Page/Quill-Portfolio-Commentary-Asset-Management}}
\end{frame}
...
\begin{frame}{Other NLG}
	...
	\pause
	\begin{multicols}{2}
		% \includegraphics[width=0.5\textwidth]{images/zelda.jpg}	%% old Zelda graphic (Fuck you)
		% \includegraphics[width=0.5\textwidth]{images/zeldapoop.png}	%% Zelda pooping graphic
		\includegraphics[width=0.5\textwidth]{images/zeldabitch.jpg}	%% Zelda bitch graphic
		% \includegraphics[width=0.5\textwidth]{images/tay.jpg}	%% old tay tweets graphic
		\includegraphics[width=0.5\textwidth]{images/tay3.png}	%% single tay tweets graphic
	\end{multicols}
...
\begin{frame}{NLG Limitations}
    \begin{center}
    	% \includegraphics[width=.5\textwidth]{images/zelda.jpg}	%% fuck you Zelda graphic
    	% \includegraphics[width=0.5\textwidth]{images/zeldapoop.png}	%% Zelda pooping graphic
    	\includegraphics[width=0.7\textwidth]{images/zeldabitch.jpg}	%% Zelda bitch graphic
    \end{center}
...
\begin{frame}{NLG Limitations}
	% \pause
	\begin{center}
		% \includegraphics[width=.7\textwidth]{images/tay.jpg}	%% old tay tweets graphic
		\includegraphics[width=.7\textwidth]{images/tay3.png}	%% new single tay tweets graphic
	\end{center}
...
\begin{frame}{Entity reference}
	\begin{quote}
		In later years, holding forth to an interviewer or to an audience of aging fans at a comic book convention, Sam Clay liked to declare, apropos of \alert{his} and Joe Kavalier's greatest creation, that back when \alert{he} was a boy, sealed and hog-tied inside the airtight vessel known as Brooklyn, New York, \alert{he} had been haunted by dreams of Harry Houdini. "To \alert{me}, Clark Kent in a phone booth and Houdini in a packing crate, \alert{they} were one and the same thing,"[...]
...
\begin{frame}{Entity reference: no ambiguity}
	\begin{quote}
		In later years, holding forth to an interviewer or to an audience of aging fans at a comic book convention, Sam Clay liked to declare, apropos of \alert{Sam Clay} and Joe Kavalier's greatest creation, that back when \alert{Sam Clay} was a boy, sealed and hog-tied inside the airtight vessel known as Brooklyn, New York, \alert{Sam Clay} had been haunted by dreams of Harry Houdini. "To \alert{Sam Clay}, Clark Kent in a phone booth and Houdini in a packing crate, \alert{Clark Kent and Houdini} were one and the same thing,"[...]
...
\begin{frame}{Entity reference: no ambiguity}
	\begin{center}
		% \includegraphics[width=.8\textwidth]{images/zelda.jpg}	%% fuck you zelda graphic
		% \includegraphics[width=0.8\textwidth]{images/zeldapoop.png}	%% Zelda pooping graphic
		\includegraphics[width=0.8\textwidth]{images/zeldabitch.jpg}	%% Zelda bitch graphic
	\end{center}
\end{frame}
...
\begin{frame}{Other factors?}
	\begin{itemize}
		\item Syntactic structure works as a strong indicator, but are there other factors at play? \pause
		\begin{itemize}
			\item recency
			\item repetition
			\item ?? \pause
...
\begin{frame}{Lost in the forest}
	\begin{center}
...
\begin{frame}{Chimerical solutions}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item from various perspectives: e.g. linguistics, comp sci, journalism,\ldots \pause
		\end{itemize}
		\item and identifying stakeholders and external constraints
		\begin{itemize}
			\item business requirements, deadlines, UX,\ldots
		\end{itemize}
	\end{itemize}
\end{frame}
