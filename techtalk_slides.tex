...
\begin{frame}{Tracking saliency}
	...
	\begin{itemize}
		...
		\item so we should ensure that the AI system also shares those principles \vspace{10pt}
		 \pause

		\item We've seen that the syntactic structure strongly influences saliency
