...
\begin{frame}{Other NLG}
	...
	\begin{multicols}{2}
		...
		\includegraphics[width=0.5\textwidth]{images/tay2.jpg}	%% single tay tweets graphic
	\end{multicols}
...
\begin{frame}{NLG Limitations}
	...
	\begin{center}
		...
		\includegraphics[width=.7\textwidth]{images/tay2.jpg}	%% new single tay tweets graphic
	\end{center}
