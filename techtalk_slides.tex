...
\begin{frame}{Grammatical features}
	\begin{itemize}
		\item \alert{Grammatical features} are properties that the grammar of any language tracks and manifests
...
\begin{frame}{Inflectional Paradigms}
	\begin{itemize}
		...
		\item This can be tracked within an \alert{inflectional paradigm}
	\end{itemize}
