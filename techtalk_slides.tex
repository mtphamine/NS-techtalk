...
% \begin{frame}{What's a use case example?}
% 	\begin{itemize}
% 		\item Companies that handle large financial transactions must report suspicious activity
% 		\item Analyzing large datasets and writing reports by hand is time and labor intensive
% 		\item AI can analyze and write these reports at scale	\pause
% 		\item saving people time to be more productive elsewhere
% 	\end{itemize}
% \end{frame}
...
\begin{frame}{Other factors?}
	\begin{itemize}
		\item Syntactic structure works as a good indicator, but are there other factors at play? \pause
		\begin{itemize}
			\item recency
			\item repetition
			\item ?? \pause
